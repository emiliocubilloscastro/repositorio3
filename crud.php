        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<a href='editar2.php?idSolicitud=".$row['idSolicitud']."' class='btn btn-primary btn-sm mr-2'>Editar</a>";
                    echo "<a href='eliminarsolicitud.php?idSolicitud=".$row['idSolicitud']."' class='btn btn-danger btn-sm'>Eliminar</a>";
                    echo "</td>";
                    echo "</tr>";
